Looking at the login.js file, we notice there is some deobfuscation needed.  After wasting about 20 minutes doing each one individually from top to bottom, I realized where the flag was.
